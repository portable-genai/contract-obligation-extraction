...
| [features-faq.md](features-faq.md) | Product / legal ops / delivery | what the engine extracts and decides, what the model is allowed to propose, and the boundary with Rgc8 and Rgc7 |
...
catalog. Where a concern belongs to another repo (the vendor-risk consumer Rgc8, the firm-wide
obligation graph Rgc7, the guardrail gateway Hrz1, the human-review console Hrz7, the eval
